...
Escenario::Escenario(sf::Texture& texturaFondo, sf::Texture& texturaFrente, sf::Texture& texturaSuelo) : texturaSuelo(texturaSuelo), suelo(sf::Quads,4) {
    ...
    suelo[0].texCoords = sf::Vector2f(0,0);
    suelo[1].texCoords = sf::Vector2f(texturaSuelo.getSize().x,0);
